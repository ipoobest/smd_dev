...
export const actions = {
  async createGrade ({ commit }, object) {
    return new Promise(async (resolve, reject) => {
      try {
        const result = this.$axios.$post(`${process.env.parseUrl}/classes/${classes.grade}`, object)
  ...
  async getGrade({ commit }) {
    return new Promise(async (resolve, reject) => {
      try {
        const result = this.$axios.$get(`${process.env.parseUrl}/classes/${classes.grade}`)
  ...
  async updateGrade({ commit }, object) {
    return new Promise(async (resolve, reject) => {
      ...
      try {
        const result = await this.$axios.$put(`${process.env.parseUrl}/classes/${classes.grade}/${objectId}`, object)
  ...
  async deleteGrade({ commit }, objectId) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const result = this.$axios.$delete(`${process.env.parseUrl}/classes/${classes.grade}/${objectId}`)
